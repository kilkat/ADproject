...
def login_check():
    ...
    if user_id.get() == "a" and password.get() == "b":
        ...
        def arp_table_scan():
            ...
            if arp_list[0] == gateway_ip:
                if arp_list[1] == gateway_mac:
        ...
        #     gateway_mac = arp_list[1]
            ...
            # f3 = open('d:\\options\\' + 'Arp_Options-' + now_time + ".txt", "r")
            # lines = f3.readlines()
            # for line in lines:
            #     line = line.split()
            #     print(line)
        ...
        arp_table_btn = Button(ARPframe_tab3, text="Detection ARP Spoofing ", command=arp_table_scan).grid(row = 0, column = 0, padx = 10, pady = 10)
